var ScalarSVG = (function () {
    function ScalarSVG(containerNode) {
        var _this = this;
        this.xIndex = 0;
        this.yIndex = 1;
    ...
    ScalarSVG.prototype.setData = function (d) {
        var _this = this;
        this.data = d;
        ...
        this.x.domain(d3.extent(this.data[0].data, function (d) { return d[_this.xIndex]; }));
        this.y.domain(d3.extent(this.data[0].data, function (d) { return d[_this.yIndex]; }));
    };
    ScalarSVG.prototype.setSize = function (w, h) {
    ...
    ScalarSVG.prototype.render = function () {
